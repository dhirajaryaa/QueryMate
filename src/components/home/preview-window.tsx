...
import {
  ...
  UserChatMessage,
} from "@/modules/message/components/message-ui";
...
export function PreviewWindow() {
  ...
  return (
    <div className=" aspect-video mx-auto border-2 border-muted-foreground/40 rounded-2xl duration-200 transition-all shadow-2xl overflow-hidden relative">
      {/* header  */}
...
export function UserMessage({
  ...
  return (
    <span className="w-auto max-w-xl self-end bg-secondary py-2 px-4 rounded-3xl text-xs sm:text-sm md:text-base">
      {message}
    </span>
  );
}
...
export function AssistantMessage({
  ...
  return (
    <span className="w-full p-2 prose dark:prose-invert max-w-none text-xs sm:text-sm md:text-base">
      {message}
    </span>
  );
}
